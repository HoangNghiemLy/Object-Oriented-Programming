...
public class PayrollApp {
	public static void main(String[] args) {
		...
		Employee[] emps = { new HourlyEmployee("HE001", "John", LocalDate.of(2001, 8, 20), 80, 20.0),
...
//				Arrays.stream(list.getHourlyEmpsWorkMoreThan40().toArray()).forEach(System.out::println);
