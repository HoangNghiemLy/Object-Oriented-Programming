...
public class Main {
	public static void main(String[] args) {
		DanhSachBenhNhan bn = new DanhSachBenhNhan(1);
		BenhNhan[] f = { new BenhNhan("01", "Ly", "Nghiem", LocalDate.of(2023, 10, 18), "0585379771", GioiTinh.Nam),
		...
		Arrays.stream(bn.getDSBN()).forEach(System.out::println);
//		System.out.println();
//		System.out.println(bn.search("02"));
	}
}
